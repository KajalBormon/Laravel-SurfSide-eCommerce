                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="stock_status">
                                ...
                                <option value="outofstock" {{ $product->stock_status=="instock" ? "selectd":"" }}>Out of Stock</option>
                            </select>
                        </div>
                    </fieldset>
                    @error('stock_staus')
    ...
    $(function(){
        ...
        $('#gFile').on('change',function(e){
            ...
            $.each(gphotos, function(key,val){
                $('#galUpload').prepend(`<div class="item gitems"><img src="${URL.createObjectURL(val)}"/>
                    </div>`)
            });
        });
