        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
              <img loading="lazy" src="{{ asset('uploads/sliders') }}/{{ $slider->image }}" width="542" height="733"
                alt="Woman Fashion 1"
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3"> {{ $slider->tagline }} </h6>
              <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5"> {{ $slider->title }} </h2>
              <h5 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">{{ $slider->subtitle }}</h5>
              <a href="{{ $slider->link }}"
            ...
            @foreach ($categories as $category)
              <div class="swiper-slide">
                ...
                <div class="text-center">
                  <a href="{{ route('home.shop',$category->id) }}" class="menu-link fw-medium">{{ $category->name }}</a>
                </div>
              </div>
            @endforeach
            </div><!-- /.swiper-wrapper -->
      ...
      <section class="hot-deals container">
        ...
        <div class="row">
          <div
            ...
            <a href="{{ route('home.shop') }}" class="btn-link default-underline text-uppercase fw-medium mt-3">View All</a>
          </div>
                ...
                @foreach ($products as $sproduct)
                  <div class="swiper-slide product-card product-card_style3">
                    ...
                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="{{ route('home.shop',$sproduct->slug) }}">{{ $sproduct->name }}</a></h6>
                ...
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price text-secondary">
                    @if($feature_product->sale_price)
                        <s>${{ $feature_product->regular_price }}</s>${{ $feature_product->sale_price }}
                    @else
                        ${{ $feature_product->regular_price }}
                    @endif
                  </span>
                </div>
