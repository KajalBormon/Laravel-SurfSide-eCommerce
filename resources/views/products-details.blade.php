            ...
            <div class="product-single__image">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{ asset('uploads/products') }}/{{ $images }}" width="674"
                      height="674" alt="" />
                    <a data-fancybox="gallery" href=".{{ asset('uploads/products') }}/{{ $images }}" data-bs-toggle="tooltip"
                      data-bs-placement="left" title="Zoom">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <use href="#icon_zoom" />
                      </svg>
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide product-single__image-item">
                      ...
                      src="{{ asset('uploads/products') }}/{{ $product->image }}" width="104" height="104" alt="" />
                    </div>
                    @foreach (explode(',',$product->image) as $images)
                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                      src="{{ asset('uploads/products/thumbnails') }}/{{ $images }}" width="104" height="104" alt="" />
                    </div>
                    @endforeach
                </div>
              </div>
        ...
        <div class="col-lg-5">
          <div class="d-flex justify-content-between mb-4 pb-md-2">
            <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
              ...
              <a href="{{ route('home.shop') }}" class="menu-link menu-link_us-s text-uppercase fw-medium">The Shop</a>
            </div><!-- /.breadcrumb -->
          ...
          @if(Cart::instance('cart')->content()->Where('id',$product->id)->count()>0)
            <a href="{{route('shop.cart')}}" class="btn btn-warning mb-3">Go to Cart</a>
          @else
          ...
          <div class="product-single__addtolinks">
            ...
            <a href="javascript:void(0)" class="filled-heart menu-link menu-link_us-s add-to-wishlist"><svg width="16" height="16" viewBox="0 0 20 20"
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="{{ route('home.shop.details',$rproduct->slug) }}">
                  <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $rproduct->image }}" width="330" height="400"
                    alt="{{ $rproduct->name }}" class="pc__img">
                    @foreach (explode(',',$rproduct->images) as $gimages)
                    <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $gimages }}" width="330" height="400"
                    alt="{{ $rproduct->name }}" class="pc__img pc__img-second">
                    @endforeach
                </a>
                @if(Cart::instance("cart")->content()->Where('id',$rproduct->id)->count()>0)
                    <a href="{{route('shop.cart')}}" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart btn-warning">Go to Cart</a>
                @else
                <form name="addtocart-form" method="POST" action="{{route('cart.add')}}">
                    @csrf
                    <div class="product-single__addtocart">
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="{{ route('home.shop.details',$rproduct->slug) }}">{{ $rproduct->name }}</a></h6>
