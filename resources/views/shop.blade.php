...
<main class="pt-90">
        ...
        <div class="accordion" id="categories-list">
          <div class="accordion-item mb-4 pb-3">
            ...
            <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
              ...
              <div class="accordion-body px-0 pb-0 pt-3 category_list">
                <ul class="list list-inline mb-0">
                    @foreach ($categories as $category)
                  <li class="list-item py-1">
                    <span class="menu-link py-1">
                        <input type="checkbox" name="categories" class="chk-category" id="categories" value="{{ $category->id }}"
                        @if(in_array($category->id,explode(',',$category_filter))) checked="checked" @endif
                        >
                        {{ $category->name }}
                    </span>
                    <span class="float-end text-right"> {{ $category->product->count() }} </span>
                  </li>
                  @endforeach
                </ul>
              </div>
                ...
                <ul class="list list-inline mb-0 brand-list">
                    ...
                    <li class="list-item">
                        <span class="menu-link">
                            <input type="checkbox" name="brands" id="" value="{{ $brand->id }}"
                ...
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      ...
                      <a href="{{ route('home.shop.details',$product->slug) }}"><img loading="lazy" src="{{ asset('uploads/products') }}/{{ $product->image }}" width="330"
                          height="400" alt="{{ $product->name }}" class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                        @foreach (explode(',',$product->images) as $gallery_images)
                            <a href="details.html"><img loading="lazy" src="{{ asset('uploads/products') }}/{{ $gallery_images }}"
  ...
  <form method="get" id="formFilter" action="{{ route('home.shop') }}">
